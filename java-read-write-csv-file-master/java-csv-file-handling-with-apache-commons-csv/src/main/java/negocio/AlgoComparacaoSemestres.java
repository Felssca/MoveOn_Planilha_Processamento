    ...
    private String etiquetasIndicadores(int tipoIndicador, int indicador) {
        ...
        switch (tipoIndicador) {
            ...
            case Constantes.TIPO_ETIQUETA_MODALIDADES_ALTURA:
                   if (indicador == Constantes.TIPO_ETIQUETA_NEGATIVO) {
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ALTURA_DIMINUICAO;
                } else if(indicador == Constantes.TIPO_ETIQUETA_POSITIVO){
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ALTURA_AUMENTO;
                }else{
                     etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ALTURA_ESTAVEL;
                }
            ...
            case Constantes.TIPO_ETIQUETA_MODALIDADES_CINTURA:
                   if (indicador == Constantes.TIPO_ETIQUETA_NEGATIVO) {
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_CINTURA_DIMINUICAO;
                } else if(indicador == Constantes.TIPO_ETIQUETA_POSITIVO){
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_CINTURA_AUMENTO;
                }else{
                     etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_CINTURA_ESTAVEL;
                }

                break;
            case Constantes.TIPO_ETIQUETA_MODALIDADES_ABDOMINAL:
                   if (indicador == Constantes.TIPO_ETIQUETA_NEGATIVO) {
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ABDOMINAL_DIMINUICAO;
                } else if(indicador == Constantes.TIPO_ETIQUETA_POSITIVO){
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ABDOMINAL_AUMENTO;
                }else{
                     etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ABDOMINAL_ESTAVEL;
                }
            ...
            case Constantes.TIPO_ETIQUETA_MODALIDADES_ENVERGADURA:
                   if (indicador == Constantes.TIPO_ETIQUETA_NEGATIVO) {
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ENVERGADURA_DIMINUICAO;
                } else if(indicador == Constantes.TIPO_ETIQUETA_POSITIVO){
                    etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ENVERGADURA_AUMENTO;
                }else{
                     etiquetaIndicador = Constantes.ZONA_CLASSIFICAÇÃO_ENVERGADURA_ESTAVEL;
                }
