...
public class TabelaXlsStyle {
    ...
    if(classificacao.equals(Constantes.ZONA_CLASSIFICA플O_PESO_GANHO)){
            cellStyle.setFillForegroundColor(IndexedColors.BLUE.getIndex());
            cellStyle.setFillPattern(FillPatternType.SOLID_FOREGROUND);
            font.setColor(IndexedColors.WHITE.index);
            cellStyle.setFont(font);
    ...
    if(classificacao.equals(Constantes.ZONA_CLASSIFICA플O_PESO_PERDA)){
                    cellStyle.setFillForegroundColor(IndexedColors.RED.getIndex());
            cellStyle.setFillPattern(FillPatternType.SOLID_FOREGROUND);
            font.setColor(IndexedColors.WHITE1.index);
            cellStyle.setFont(font);
    ...
    if(classificacao.equals(Constantes.ZONA_CLASSIFICA플O_PESO_ESTAVEL)){
             cellStyle.setFillForegroundColor(IndexedColors.YELLOW.getIndex());
            cellStyle.setFillPattern(FillPatternType.SOLID_FOREGROUND);
            font.setColor(IndexedColors.BLACK.index);
            cellStyle.setFont(font);
