...
public class PlanilhaResultadoConteudo {
    ...
    public void montarConteudo(List<Alunos> listaAluno, XSSFSheet sheetAlunos, XSSFWorkbook workbook, TabelaXlsStyle tabelaXlsStyle) {
        ...
        for (Alunos alunos : listaAluno) {
            ...
            if (alunos.getIndicadoresIMCTab3().equals(Constantes.ZONA_CLASSIFICA플O_IMC_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresIMCTab3().equals(Constantes.ZONA_CLASSIFICA플O_IMC_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresRCETab3().equals(Constantes.ZONA_CLASSIFICA플O_RCE_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresRCETab3().equals(Constantes.ZONA_CLASSIFICA플O_RCE_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresFlex().equals(Constantes.ZONA_CLASSIFICA플O_FLEXIBILIDADE_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresFlex().equals(Constantes.ZONA_CLASSIFICA플O_FLEXIBILIDADE_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresMedBall().equals(Constantes.ZONA_CLASSIFICA플O_MEDBALL_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresMedBall().equals(Constantes.ZONA_CLASSIFICA플O_MEDBALL_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresSalto().equals(Constantes.ZONA_CLASSIFICA플O_SALTO_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresSalto().equals(Constantes.ZONA_CLASSIFICA플O_SALTO_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresAgilidade().equals(Constantes.ZONA_CLASSIFICA플O_AGILIDADE_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresAgilidade().equals(Constantes.ZONA_CLASSIFICA플O_AGILIDADE_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            ...
            if (alunos.getIndicadoresVerlocidade().equals(Constantes.ZONA_CLASSIFICA플O_VELOCIDADE_AUMENTO)) {
                sinalIndicativo = " + ";
            }
            if (alunos.getIndicadoresVerlocidade().equals(Constantes.ZONA_CLASSIFICA플O_VELOCIDADE_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            ...
            if (alunos.getIndicadoresCorrida_6().equals(Constantes.ZONA_CLASSIFICA플O_CORRIDA6_DIMINUICAO)) {
                sinalIndicativo = " - ";
            }
            if (alunos.getIndicadoresCorrida_6().equals(Constantes.ZONA_CLASSIFICA플O_CORRIDA6_AUMENTO)) {
                sinalIndicativo = " + ";
            }
